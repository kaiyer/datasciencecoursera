...
par(mfrow=c(2,2))
# first plot
plot(DF$dt, DF$Global_active_power, type="n", xlab = "", ylab="Global Active Power (kilowatts)")
lines(DF$dt, DF$Global_active_power) 
# second plot
...
# fourth plot
plot(DF$dt, DF$Global_reactive_power, type="n", xlab = "datetime", ylab="Global_reactive_power")
